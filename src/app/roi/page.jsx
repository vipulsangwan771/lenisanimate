...
const RoiPage = () => {
  ...
  return (
    <div className="bg-(--primary-bg) min-h-screen w-full p-5 pt-10 text-white">
      {/* Tabs */}
      <div className="flex gap-1 justify-between md:max-w-[435] mx-[auto] border bg-(--primary-card-bg) rounded-lg border-(--primary-border) mb-5 p-1">
        <button
          onClick={() => setActiveTab("coin")}
          className={`md:px-4 px-1 py-2 w-full font-semibold ${
            activeTab === "coin"
      ...
      {/* Tab Content */}
      <div className="bg-(--primary-card-bg) p-6 rounded-lg max-w-[1100px] mx-[auto]  border-(--primary-border) border">
        {activeTab === "coin" && (
          <div>
